...
public Map<String, Object> handleMethodArgumentTypeMismatchException(MethodArgumentTypeMismatchException e, WebRequest webRequest){
        return createExceptionsMessage(e, HttpStatus.BAD_REQUEST,webRequest,LogStatus.MESSAGE_ONLY);
}
    ...
    public Map<String, Object> handleException(Exception e, WebRequest webRequest){
        return  createExceptionsMessage(e, HttpStatus.INTERNAL_SERVER_ERROR, webRequest, LogStatus.STACK_TRACE );
    }
    ...
    public Map<String, Object> handleNoSuchElementException(NoSuchElementException e, WebRequest webRequest){
        return createExceptionsMessage(e, HttpStatus.NOT_FOUND, webRequest, LogStatus.MESSAGE_ONLY);
    }


    private Map<String, Object> createExceptionsMessage(Exception e, HttpStatus status, WebRequest webRequest, LogStatus logStatus) {
